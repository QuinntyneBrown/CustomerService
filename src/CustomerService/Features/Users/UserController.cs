...
using static CustomerService.Features.Users.AddOrUpdateUserCommand;
using static CustomerService.Features.Users.GetUsersQuery;
using static CustomerService.Features.Users.GetUserByIdQuery;
using static CustomerService.Features.Users.RemoveUserCommand;
using static CustomerService.Features.Users.GetUserByUsernameQuery;
