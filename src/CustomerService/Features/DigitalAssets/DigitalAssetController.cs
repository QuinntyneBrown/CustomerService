using MediatR;
using CustomerService.Features.DigitalAssets.UploadHandlers;
...
using static CustomerService.Features.DigitalAssets.GetDigitalAssetByUniqueIdQuery;
using static CustomerService.Features.DigitalAssets.AzureBlobStorageDigitalAssetCommand;
using static CustomerService.Features.DigitalAssets.GetDigitalAssetsQuery;
using static CustomerService.Features.DigitalAssets.GetDigitalAssetByIdQuery;
using static CustomerService.Features.DigitalAssets.RemoveDigitalAssetCommand;
using static CustomerService.Features.DigitalAssets.AddOrUpdateDigitalAssetCommand;
