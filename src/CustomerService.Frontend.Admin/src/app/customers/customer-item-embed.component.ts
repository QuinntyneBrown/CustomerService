...
const template = require("./customer-item-embed.component.html");
const styles = require("./customer-item-embed.component.scss");

export class CustomerItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new CustomerDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new CustomerEdit(this.entity));
    }
...
customElements.define(`ce-customer-item-embed`,CustomerItemEmbedComponent);
